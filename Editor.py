...
from PyQt5.QtWidgets import (QMainWindow, QApplication, QAction, QFontComboBox, QSpinBox, 
	QTextEdit, QMessageBox, QFileDialog, QColorDialog, QDialog)
...
class Main(QMainWindow):
	...
	def initUI(self):
		...
		self.text = PyQt5.Qsci.QsciScintilla()
		self.text.setText("Initialization Example")
		self.text.append("\nAdded Text")
		self.text.show()
